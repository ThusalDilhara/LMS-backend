...
public class ProjectSecurityProdConfig {
    ...
    public AuthenticationManager authenticationManager(UserDetailsService userDetailsService, PasswordEncoder passwordEncoder) {
        ProjectLMSProdUsernamePasswordAuthenticationProvider authenticationProvider = new ProjectLMSProdUsernamePasswordAuthenticationProvider(userDetailsService, passwordEncoder);
